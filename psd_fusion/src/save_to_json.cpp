...
void SaveFileToJson::SaveUssInfoToJson(UssIf_stPLVOutputInfo_t info,const std::string &filename){
    ...
    //         j_slot_property["enmSlotType"] = to_int(slot_property.enmSlotType);
    //         j_slot_property["enmSlotBottomType"] = to_int(slot_property.enmSlotBottomType);
    ...
    //         j_slot_property["enmInSlotObstacleStatus"] = to_int(slot_property.enmInSlotObstacleStatus);
    ...
    //         j_slot_property["enmDownSlotSODType"] = to_int(slot_property.enmDownSlotSODType);
